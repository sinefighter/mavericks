...
<main class="main" id="main">
	<?php
	    get_template_part( 'parts/block-title');
	?>
	...
	<section class="section section-pd">
		<div class="wrap">
			...
			<a href="#" class="to-video">
				<img src="<?php echo get_template_directory_uri(); ?>/dist/img/course.jpg" alt="">
    ...
    <section class="section section-pd bg-light-grey">
		<div class="wrap">
            <div class="row">
                <div class="col-12">
                    <form action="#">
                        <label class="label-text">
                            <input type="text" name="name" class="input-text" placeholder="Ім'я" required>
                            <span class="label-placeholder">Ім'я</span>
                            <span class="label-line"></span>
                            <span class="help-text">Ім'я</span>
                            <span class="sign-text"></span>
                        </label>
                        <label class="label-text">
                            <input type="text" name="surname" class="input-text" placeholder="Призвище" required>
                            <span class="label-placeholder">Призвище</span>
                            <span class="label-line"></span>
                            <span class="help-text">Призвище</span>
                            <span class="sign-text"></span>
                        </label>
                        <label class="label-text">
                            <input type="text" name="position" class="input-text" placeholder="Посада">
                            <span class="label-placeholder">Посада</span>
                            <span class="label-line"></span>
                            <span class="help-text">Посада</span>
                            <span class="sign-text"></span>
                        </label>
                        <label class="label-text">
                            <input type="text" name="website" class="input-text" placeholder="Веб-сайт">
                            <span class="label-placeholder">Веб-сайт</span>
                            <span class="label-line"></span>
                            <span class="help-text">Веб-сайт</span>
                            <span class="sign-text"></span>
                        </label>
                        <label class="label-text">
                            <textarea name="comment" class="input-text input-textarea" rows="3" style="height: 57px;" required></textarea>
                            ...
                            <span class="help-text">Коментар</span>
                        </label>
                        <br>
                        <button class="btn" type="submit" id="send-form">Відправити форму</button>
                    </form>
                </div>
            </div>
        </div>
	...
	<section class="section section-pd">
		<div class="wrap">
			...
			<div class="row card-square-amount" id="list-events">
				<div class="col-6 col-md">
                ...
                <?php
                    ...
                    $count_posts = $latest_events->found_posts;
                ?>
			...
			<div class="t-center">
				<a href="javascript;" class="btn" id="load-events" 
                    data-count="<?php echo $count_posts; ?>"
                    data-per-page="<?php echo $posts_per_page + 1; ?>"
                    data-current="<?php echo $posts_per_page; ?>"
                >
					Ще заходи
				</a>
			</div>
			...
			<div class="row card-full-light-amount">
				<div class="col">
					<div class="card-full-light">
						...
						<img src="<?php echo get_template_directory_uri(); ?>/dist/img/card.jpg" alt="" class="cover-img">
					</div>
				</div>
				<div class="col">
					<div class="card-full-light">
	...
	<section class="section section-pd bg-light-grey t-center">
		<div class="wrap">
			...
			<ul class="slider partners-slider" id="partners">
				<li class="slider-item"><img src="<?php echo get_template_directory_uri(); ?>/dist/img/partners/hub.svg" alt=""></li>
				<li class="slider-item"><img src="<?php echo get_template_directory_uri(); ?>/dist/img/partners/microsoft.svg" alt=""></li>
				<li class="slider-item"><img src="<?php echo get_template_directory_uri(); ?>/dist/img/partners/atb.svg" alt=""></li>
				<li class="slider-item"><img src="<?php echo get_template_directory_uri(); ?>/dist/img/partners/hub.svg" alt=""></li>
				<li class="slider-item"><img src="<?php echo get_template_directory_uri(); ?>/dist/img/partners/microsoft.svg" alt=""></li>
				<li class="slider-item"><img src="<?php echo get_template_directory_uri(); ?>/dist/img/partners/atb.svg" alt=""></li>
				<li class="slider-item"><img src="<?php echo get_template_directory_uri(); ?>/dist/img/partners/hub.svg" alt=""></li>
